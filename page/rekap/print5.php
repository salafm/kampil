	...
	<!-- Content Wrapper. Contains page content ------------------------------------------------------------>
      <div class="content-wrapper">
	  	<?php
			...
			// Assign the query
			$query = "SELECT * FROM penduduk WHERE pindah='Pindah rumah' AND (year(buat) = '$thn' AND month(buat) = '$bln')";
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Print Laporan Pindah</li>
          </ol>
        </section>
