	...
	<!-- Content Wrapper. Contains page content ------------------------------------------------------------>
      <div class="content-wrapper">
	  	<?php
			...
			// Assign the query
			$query = "SELECT * FROM penduduk WHERE (SUBSTRING_INDEX(SUBSTRING_INDEX(tglLahir,'/',2),'/',-1)+0 = '$bln' AND (SUBSTRING_INDEX(tglLahir,'/',-1)+0 = '$thn')) 
			AND (pindah='Meninggal') AND (year(last) = '$thn' AND month(last) = '$bln')";
        ...
        <section class="content-header">
         ...
         <ol class="breadcrumb">
			...
			<li class="active">Print Laporan Lahir Mati</li>
          </ol>
        </section>
          ...
          <div class="callout callout-info" style="margin-bottom: 0!important;">
			...
			<div class="pull-right" >
				...
				<select class="isi" id="cetak" onChange="pilih()">
					...
					<option value='print3.php' selected>Lahir Mati</option>
			...
			<div class="page">
				<div class="subpage">
					<h2 align="center" class="kop">
						<b>LAPORAN PENCATATAN LAHIR MATI</b>
					</h2><br><br>
					<div class="isi">
						<table width="100%">
							<tr>
