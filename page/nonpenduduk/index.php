      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Database Non Penduduk</li>
          </ol>
        </section>
		...
		<form method='get' action="cari.php">
          <?php 
				...
				$query1 = "SELECT * FROM penduduk WHERE ((pindah='Meninggal') OR (pindah='Pindah rumah'))";
				$result1 = mysqli_query($con,$query1);
				$max = mysqli_num_rows($result1);
				
				// Assign the query
				$query = "SELECT * FROM penduduk WHERE ((pindah='Meninggal') OR (pindah='Pindah rumah')) ORDER BY last DESC LIMIT $startrow, 10"; 
