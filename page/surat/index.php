      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Database Surat</li>
          </ol>
        </section>
		...
		<form method='get' action="cari.php">
          <?php 
				...
				$query1 = "SELECT surat.*, penduduk.nama FROM surat, penduduk WHERE surat.idpenduduk = penduduk.id ORDER BY surat.id DESC";
				...
				echo "<tr>";
					...
					echo "<th style='text-align:center'>Lampiran</th>";
					echo "<th style='text-align:center'>Upload Surat</th>";
				echo "</tr>";
				$i=$startrow+1;
				...
				if($lampiran == null){
				  ...
				  echo '<tr>';
					  ...
					  echo '<td>'.$row['nama'].'</td>';
					  echo '<td>'.$tgl.'</td>';
					  echo '<td align="center"><a href="'.$href.'" class="btn btn-sm bg-blue '.$disabled.'" role="button" target="'.$target.'">Lihat</a></td>';
