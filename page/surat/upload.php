...
<html>
	...
	<!-- Content Wrapper. Contains page content ------------------------------------------------------------>
      <div class="content-wrapper">
		...
		<form method="POST" autocomplete="on" action="simpan.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
		<div class='box'>
		<table class="table table-bordered" width="100%" style="font-size:12pt">
			...
			<tr>
				...
				<td>:</td>
				<td>
					<input type ="file" name="file" accept=".pdf, .xps"  placeholder="Ukuran file maks 2 MB">
			...
			<tr>
				<td></td>
				<td></td>
				<td><input type="submit" name="submit" value="Upload" class="btn btn-m bg-green pull-right"></td> 
			</tr>
		</table>
		</div>
        </section><!-- /.content -->
