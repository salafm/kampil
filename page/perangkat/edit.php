      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Pengaturan Perangkat Desa</li>
...
?>
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<td>:</td>
				<td>
					<input type ="text" name="nip" size="30" maxlength="18" placeholder="Maksimal 18 digit angka" pattern="[0-9 ]+" title="Hanya angka dan yg diperbolehkan" value="<?php echo $nip;?>"/>
				</td>
			</tr>
			<tr>
				...
				<td>:</td>
				<td>
					<input type ="text" name="cp" size="30" maxlength="18" placeholder="Silahkan isi dengan no. HP" pattern="^(0|[0-9][0-9]*)$" title="Hanya angka dan yg diperbolehkan" value="<?php echo $cp;?>"/>
				</td>
			</tr>
			<tr>
				<td valign="top">
