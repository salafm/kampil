...
<html>
  <head>
    ...
    <title>Desa Kampil | Pengaturan Perangkat Desa</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="../penduduk"><i class="fa fa-users"></i> <span>Database Penduduk</span></a></li>
			...
			<li class="active"><a href="index.php"><i class="fa fa-user-secret"></i> <span>Pengaturan Perangkat Desa</span></a></li>
